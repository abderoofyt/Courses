...
This is because JavaScript detects the variable's data type by reading how data is
assigned to the variable. You begin your declaration with the keyword 'let' followed by
the name of your variable.You use the assignment operator '=' to assign a value to a variable. */

// ============ Example 1 ============
let num = 12; // number
/* The variable num is assigned the integer or whole number 12, due to the presence 
of digits and lack of quotation marks. */

let num2 = 12.42; // number
/* The variable num2 is assigned the float or decimal number 12.42, due to the presence 
of the decimal point and lack of quotation marks. */
...
/* The variable myWords is assigned the array ["hi", "there"] due to the presence of
square brackets ([...]). */

// ============ Example 4 ============
let myObject = { colour: "blue", time: "8pm" };
/* The variable myObject is assigned the object {colour: "blue", time: "8pm"} due to the presence 
of curly brackets ({...}) and key-value pairs (key:value) separated by a comma (,). */

// ============ Example 5 ============
let numberString = "10";
/* Watch out! Because you defined 10 within quotation marks, JavaScript knows this is a string.
It's not an integer even though we understand 10 as a number. */
...
Note: You only use 'let' when actually declaring a new variable, not when merely
...
console.log(
  "The area of a square with the width of " + num + " is " + num * num
);

console.log(
  "The radius of a circle with the radius of " +
    num +
    " is " +
    num * num * Math.PI
);
...
console.log(
  "The remainder when dividing " + num + " by " + num3 + " is " + (num % num3)
);
...
let total = num4 + num5; // Add numbers together and store the result in total
